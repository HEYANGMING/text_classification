...
# Data Parameters
tf.flags.DEFINE_string("input_text_file", "/home/heyangm/Desktop/dc_cnn/data/spam_100.utf8", "Test text data source to evaluate.")
tf.flags.DEFINE_string("input_label_file", "", "Label file for test text data source.")  # lable file

# Eval Parameters
tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
tf.flags.DEFINE_string("checkpoint_dir", "/home/heyangm/runs/1524662312/checkpoints/model-100.meta", "Checkpoint directory from training run")  # chekpoint dir
...
trained_word2vec_model_file = os.path.join(FLAGS.checkpoint_dir, "/home/heyangm/runs/1524662312/checkpoints/model-100.meta", "trained_word2vec.model") 
...
training_params_file = os.path.join(FLAGS.checkpoint_dir, "/home/heyangm/runs/1524662312/checkpoints/model-100.meta", "training_params.pickle")
...
out_path = os.path.join(FLAGS.checkpoint_dir, "/home/heyangm/runs/1524662312/checkpoints/model-100.meta", "prediction.csv")
