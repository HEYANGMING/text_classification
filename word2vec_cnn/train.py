...
tf.flags.DEFINE_string("positive_data_file", "/home/heyangm/Desktop/dc_cnn/data/ham_5000.utf8", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "/home/heyangm/Desktop/dc_cnn/data/spam_5000.utf8", "Data source for the negative data.")
tf.flags.DEFINE_integer("num_labels", 6, "Number of labels for data. (default: 6)") #标签数量

# Model hyperparameters
tf.flags.DEFINE_integer("embedding_dim", 100, "Dimensionality of character embedding (default: 100)") #嵌入层维度
